...
console.log(friendsStore.addQAParticipant); // 이 로그로 함수가 실제로 존재하는지 확인
const selectParticipant = (participant) => {
    console.log(participant)
    // if (!friendsStore.selectedParticipants.value.includes(participant)) {
        console.log(participant);
        friendsStore.addQAParticipant(participant);
...
<template>
    <div class="search-friends">
        <div class="input-wrap">
            ...
            <div class="input-btn-wrap">
                ...
                <div v-if="friendsStore.participantsName" class="search-results">
                    <div v-for="user in friendsStore.filteredUsers" :key="user.id" @click="selectParticipant(user)">
        ...
        <div class="participants-list">
            <div v-for="participant in friendsStore.participants" :key="participant.id" class="participants-item">
