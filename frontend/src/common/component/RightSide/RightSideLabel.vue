...
const labels = ref((typeof sprintLabelStore.getLabels === 'function' ? sprintLabelStore.getLabels() : []) || []);
            ...
            <div class="input-wrap">
                ...
                <div>
                    <div class="input-wrap-item">
                        ...
                        <select id="label-select" v-model="selectedLabelName" class="input-field"
                                @change="showLabelDetails">
                ...
                <div class="input-wrap-item">
                    ...
                    <input type="text" id="label-name" v-model="labelName" placeholder="Name label"
                           class="input-field"/>
                </div>
              ...
              <span v-for="color in labelColorPalette" :key="color.id"
                    :style="{ backgroundColor: color.backgroundColor, color: color.color }"
                    @click="setLabelColor(color.backgroundColor)" class="color-swatch">
                {{ color.id }} label
              </span>
                        </div>
                    </div>
