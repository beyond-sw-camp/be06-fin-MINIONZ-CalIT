        ...
        children: [
          {
            ...
            name: 'MyMonthly',
            component: () =>
              import('@/view/schedule/monthly/MyMonthlyPage.vue'),
          },
          {
            path: 'weekly',
            name: 'myWeekly',
        ...
        children: [
          {
            ...
            name: 'MyTaskKanban',
            component: () =>
              import('@/view/scrum/Task/kanban/MyTaskKanbanPage.vue'),
          },
          {
            path: 'list',
            name: 'MyTaskList',
            component: () =>
              import('@/view/scrum/Task/list/MyTaskListPage.vue'),
          },
        ],
      },
    ],
        ...
        children: [
          {
            ...
            component: () =>
              import('@/view/schedule/monthly/WorkSpaceMonthlyPage.vue'),
          },
          {
            path: 'weekly',
            name: 'WorkspaceWeekly',
            component: () =>
              import('@/view/schedule/weekly/WorkSpaceWeeklyPage.vue'),
          },
        ],
      },
          ...
          },
          {
            ...
            children: [
              ...
              },
              {
                ...
                component: () =>
                  import('@/view/scrum/create/SprintCreatePage.vue'),
              },
              {
                path: 'detail/:sprintId',
                name: 'WorkspaceSprintDetail',
                component: () =>
                  import('@/view/scrum/detail/SprintDetailPage.vue'),
              },
            ],
          },
          {
            ...
            children: [
              ...
              },
              {
                ...
                component: () =>
                  import(
                    '@/view/scrum/Task/kanban/WorkSpaceTaskKanbanPage.vue'
                  ),
              },
              {
                path: 'list',
                ...
                component: () =>
                  import('@/view/scrum/Task/list/WorkSpaceTaskListPage.vue'),
              },
              {
                path: 'timeline',
                name: 'WorkspaceTaskTimeline',
                component: () =>
                  import('@/view/scrum/Task/timeline/TimeLinePage.vue'),
              },
            ],
          },
          {
            ...
            children: [
              ...
              },
              {
                ...
                component: () =>
                  import('@/view/scrum/detail/IssueDetailPage.vue'),
              },
              {
                path: 'create',
                name: 'WorkspaceIssueCreate',
                component: () =>
                  import('@/view/scrum/create/IssueCreatePage.vue'),
              },
            ],
          },
          {
            ...
            children: [
              {
                ...
                component: () =>
                  import('@/view/scrum/meeting/MeetingListPage.vue'),
              },
              {
                path: 'detail/:meetingId',
                name: 'BoardMeetingDetail',
                component: () =>
                  import('@/view/scrum/meeting/MeetingDetailPage.vue'),
              },
              {
                path: 'create',
                name: 'BoardMeetingCreate',
                component: () =>
                  import('@/view/scrum/meeting/MeetingCreatePage.vue'),
              },
              {
                path: 'edit/:meetingId',
                name: 'BoardMeetingEdit',
                component: () =>
                  import('@/view/scrum/meeting/MeetingEditPage.vue'),
              },
            ],
          },
          {
                ...
                children: [
                  {
                    ...
                    name: 'ErrorList',
                    component: () =>
                      import('@/view/board/list/ErrorListPage.vue'),
                  },
                  {
                    path: 'detail/:boardId',
                    name: 'ErrorDetail',
                    component: () =>
                      import('@/view/board/detail/ErrorDetailPage.vue'),
                  },
                  {
                    path: 'create',
                    name: 'ErrorCreate',
                    component: () =>
                      import('@/view/board/create/ErrorCreatePage.vue'),
                  },
                ],
              },
              {
                ...
                children: [
                  ...
                  },
                  {
                    ...
                    name: 'QACreate',
                    component: () =>
                      import('@/view/board/create/QACreatePage.vue'),
                  },
                ],
              },
            ],
