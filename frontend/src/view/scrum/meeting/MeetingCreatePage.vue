        ...
        <div class="meeting-note-container">
            <div class="meeting-input-wrap">
                ...
                <div class="issue-section">
                    ...
                    <multiselect v-model="selectedLabel" :options="filteredLabels" :searchable="true"
                        :close-on-select="true" :show-labels="false" placeholder="라벨을 선택하세요" label="labelName"
                        track-by="labelId" />
                ...
                <div class="issue-section">
                    ...
                    <multiselect v-model="selectedIssue" :options="filteredIssues" :searchable="true"
                        :close-on-select="true" :show-labels="false" placeholder="이슈를 선택하세요" label="title"
                        track-by="issueId" />
