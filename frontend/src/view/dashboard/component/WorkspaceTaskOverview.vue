  ...
  <div class="task-overview">
    <div class="overview-item">
      <div class="item-title">
        <img :src="itemIcon1" alt="sprints" />
        <p>Sprints</p>
      </div>
      <div class="item-contents">
        <p class="highlight">{{ sprintCount }}</p>
        <a href="#">See all</a>
      </div>
    </div>
    <div class="overview-item">
      ...
      <div class="item-contents">
        <div class="item-nums">
          <p class="highlight">{{ tasksCompleted }}</p>
          <p>/{{ totalTasks }}</p>
        </div>
        <a href="#">See all</a>
      </div>
    ...
    <div class="overview-item">
      ...
      <div class="item-contents">
        <p class="highlight">{{ completionRate.toFixed(2) }}%</p>
        <a href="#">See all</a>
      </div>
    </div>
    <div class="overview-item">
      ...
      <div class="item-contents">
        <p class="highlight">{{ issueCount }}</p>
        <a href="#">See all</a>
      </div>
    </div>
  </div>
