...
<template>
  <div class="calendar-container">
    ...
    <ScheduleModal v-if="isVisible" :title="props.title" :contents="props.contents" :start-date="props.startDate" :end-date="props.endDate" :participants="props.participants" />
  </div>
</template>
