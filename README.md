...
현대의 많은 사용자들은 카카오톡, 잔디(Jandi), 이메일 등 다양한 협업 도구를 사용하지만, 각 도구들이 특정 기능에만 한정되어 있거나 프로젝트 관리와 팀 협업을 동시에 지원하지 못하는 한계가 있습니다. 저희는 이러한 문제를 해결하고자 캘릿을 개발하였습니다.

### 🎯 프로젝트 목표
캘릿은 스크럼 관리, 실시간 소통, 회의 및 작업 관리 등을 한 플랫폼에서 통합적으로 제공하여 협업 도구 간의 분산된 기능을 하나로 모았습니다.

### ✨ 주요 기능

##### 1.	📅 통합 일정 관리
* 팀의 모든 일정을 한 곳에서 관리하여 여러 툴을 사용할 필요 없이 효율적인 일정 관리가 가능합니다.
##### 2.	⏰ 체계적인 알람 기능
* 각 항목의 마감일과 회의 일정에 맞춰 알람을 제공하여 중요한 일정을 놓치지 않도록 돕습니다.
##### 3.	🛠 스크럼 관리 최적화
* 스프린트, 태스크, 이슈 등의 프로젝트 진행을 스크럼 방식으로 관리하여 생산성 현황과 진행 상황을 명확하게 파악할 수 있습니다.
##### 4.	💬 실시간 채팅 및 피드백 기능
* 팀원 간 실시간 소통을 통해 즉각적인 피드백이 가능하여 협업을 원활하게 진행할 수 있습니다.
##### 5.	📝 동시 편집 가능한 회의록
* 실시간으로 회의록을 동시 편집할 수 있으며, 수정과 업데이트가 즉각 반영됩니다.
<br/>
